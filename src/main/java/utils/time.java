...
/**
 *
 * @author Max Brito, 20th of March 2011 at Germany
 */
public class time {
...
//             return calendar.getTimeInMillis();   
    ...
    /**
     * Returns the age of a given file using days as value A result of "1" means
     * today, "2" means more than 24 hours and so forth
     *
     * @param file
     * @return
     */
     ...
     * @return An ISO-style date representation
     */
    public static String getTimeStampAsFileName(Date date) {
        // do the time calculation such as 2012-09-03T13:32:12Z
        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss");
        final String textDate = dateFormat.format(date);
        return textDate;
    ...
    /**
     * An error happened. This method will show a message and decreasing timer
     * until the requested waiting time has expired. This is mostly used with
     * network connections, which require trying several times.
     *
